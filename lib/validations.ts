...
export const projectSchema = z.object({
  ...
  areaLabel: z.string().trim().optional(),
...
export const siteContentSchema = z.object({
  ...
  homeFeaturedVideoUrl: z.string().url(),
  homePortfolioTitle: z.string().nullish().transform((value) => value ?? ""),
  homePortfolioDescription: z.string().nullish().transform((value) => value ?? ""),
  homePortfolioItems: z.string().nullish().transform((value) => value ?? ""),
  ...
  portfolioTitle: z.string().nullish().transform((value) => value ?? ""),
  portfolioDescription: z.string().nullish().transform((value) => value ?? ""),
  portfolioGallery: z.string().nullish().transform((value) => value ?? ""),
