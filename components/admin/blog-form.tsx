...
export function BlogForm({ post }: { post?: Record<string, any> }) {
  return (
    <form action={createOrUpdateBlogPost} className="grid gap-4 rounded-[28px] border border-white/10 bg-white/5 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Input id="blog-cover-image" name="coverImage" placeholder="Cover image path or URL" defaultValue={post?.coverImage} required />
